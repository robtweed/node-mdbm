...
29 September 2010: Rob Tweed, M/Gateway Developments Ltd
...
OperationHelper.prototype.set = function(modifiers, json, callback) {
  this.execute("Set",modifiers,json,callback);
};
...
OperationHelper.prototype.setJSON = function(modifiers, json, callback) {
...
OperationHelper.prototype.increment = function(modifiers, json, callback) {
  this.execute("Increment",modifiers,json,callback);
};

OperationHelper.prototype.decrement = function(modifiers, json, callback) {
  this.execute("Decrement",modifiers,json,callback);
};

OperationHelper.prototype.order = function(modifiers, json, callback) {
  this.execute("Order",modifiers,json,callback);
};

OperationHelper.prototype.orderAll = function(modifiers, json, callback) {
